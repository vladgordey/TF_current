...
module "my_sg_mod" {
	...
	vpc_id = "${module.my_vpc_mod.vpc_id}"
	short_name ="${var.short_name}"
}

module "my_elb_mod" {
    source = "github.com/vladgordey/TF_ELB_mod"
	sec_group = "${module.my_sg_mod.elb_sg}"
	subnets = ["${module.my_vpc_mod.subnets}"]
}
...
rds_security_group_id="${module.my_sg_mod.rds_sg}"
db_parameter_group="${var.db_parameter_group}"
publicly_accessible="${var.publicly_accessible}"
subnet_az1="${module.my_vpc_mod.subnet_0}"
subnet_az2="${module.my_vpc_mod.subnet_1}"
}
